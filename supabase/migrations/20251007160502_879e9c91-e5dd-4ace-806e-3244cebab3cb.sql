...
DROP POLICY IF EXISTS "Admins can view all activity" ON public.user_activity_timeline;
DROP POLICY IF EXISTS "System can insert activity" ON public.user_activity_timeline;
DROP POLICY IF EXISTS "Users can view their own activity" ON public.user_activity_timeline;
DROP POLICY IF EXISTS "Admins can manage impersonation sessions" ON public.user_impersonation_sessions;
DROP POLICY IF EXISTS "Admins can manage duplicate groups" ON public.duplicate_account_groups;
...
DROP TRIGGER IF EXISTS update_duplicate_groups_updated_at_trigger ON public.duplicate_account_groups;

...
import { influencerStaysForHostsData } from "@/data/seo-landing-pages";
...
const InfluencerStaysForHosts = () => {
  useReferralCapture();
  const data = influencerStaysForHostsData;

  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "Influencer Stays for Hosts", url: `/${data.slug}` }
  ]);
...
export default InfluencerStaysForHosts;

...
import { ugcForVacationRentalsData } from "@/data/seo-landing-pages";
...
const UGCForVacationRentals = () => {
  useReferralCapture();
  const data = ugcForVacationRentalsData;

  const breadcrumbSchema = generateBreadcrumbSchema([
    { name: "Home", url: "/" },
    { name: "UGC for Vacation Rentals", url: `/${data.slug}` }
  ]);
...
export default UGCForVacationRentals;
